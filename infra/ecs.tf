    ...
    [
      {
        ...
        "environment" = [
          ...
          {
            "NAME" : "DB_PORT",
            "value" : "${var.containerDbPort}"
          },
          {
            "NAME" : "DB_NAME",
            "value" : "${var.containerDbName}"
          },
          {
            "NAME" : "DB_USERNAME",
            "value" : "${var.containerDbUser}"
          },
          {
            "NAME" : "DB_PASSWORD",
            "value" : "${var.containerDbPassword}"
          },
          {
            "NAME" : "DB_ROOT_PASSWORD",
            "value" : "${var.containerDbRootPassword}"
          },
          {
